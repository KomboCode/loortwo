...
const LoanSchedule = ({ person}) => {
    ...
    var interestOnly =  interest * principal/100;
    ...
    if ( (perday === "Per day") || (perday === "Per Week") || (perday === "Per Month") || (perday === "Per Year")) {
        interestPerday =  interest * principal/100;
        kila = principalPerday + interestPerday;
       }
    ...
    for ( var m = 1; m <= number; m++ ) {
        ...
        repayments.forEach((repay) => {
         ...
         var myObj = {
            ...
            saba: 0,
            zero: due/number,
            zeroo: interestOnly + principalPerday,
            nane: due,
            tisa: ukwaju,
            kumi: mao,
    ...
    return (
        <section className='loan-schedule'>
           ...
           <div className='info'>
            ...
            sita, zero,zeroo, saba, nane, tisa, kumi, kumimoja, kumimbili, index,
            ...
            if ( (perday === "Per day") || (perday === "Per Week") || (perday === "Per Month") || (perday === "Per Year")) {
                    ...
                    wekaa =  <h4>{Intl.NumberFormat("en-US",options).format(zeroo)}.00</h4>
                }
