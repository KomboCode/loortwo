...
const LoanSchedule = ({ person}) => {
    ...
    const { release, duration, number, due, principal, interest, 
        repayments, cycle, perday } = person;

    console.log("pers what exactly", perday);
    console.log("pers what cycle", cycle);
    ...
    const interestOnly =  interest * principal/100;
    ...
    if ( (perday === "Per day") || (perday === "Per Week") || (perday === "Per Month") || (perday === "Per Year")) {
        interestPerday =  interest * principal/100;
       }
    ...
    for ( var m = 1; m <= number; m++ ) {
        ...
        repayments.forEach((repay) => {
         ...
         ukwaju = ukwaju + (principalPerday + interestPer);
         ...
         var myObj = {
            ...
            sita: 0,
            saba: 0,
            zero: interestPer + principalPerday,
            nane: due,
            tisa: ukwaju,
            kumi: mao,
    ...
    return (
        <section className='loan-schedule'>
           ...
           <div className='info'>
            ...
            const { moja, mbili, tatu, nne, tano, tanoo,
            sita, zero, saba, nane, tisa, kumi, kumimoja, kumimbili, index,
            kumitatu, kuminne } = item;

            if ( tano === "Interest") {
                console.log("Daaaaaaaaaaa apa noma");
            } else {
                console.log("Do thaaaaaaaaaaaaaaaaaaaaaaaaat");
            }

            {/* var duee = principalPerday + tanoo; */}
                    ...
                    <div  
                      ...
                      >
                        ...
                        <h4>{Intl.NumberFormat("en-US",options).format(tano)}.00</h4>
                         : 
                            <h4>{Intl.NumberFormat("en-US",options).format(tanoo)}.00</h4>
                          }
