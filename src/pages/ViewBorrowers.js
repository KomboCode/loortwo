            ...
            <table className="content-table">
                ...
                <tbody>
                    { borrowers.map((borrower, index) => {
                        const { first, last, mobile, unique, id, repayments,
                        principal, tinterest } = borrower;
                        var no = index + 1;

                        var open = parseInt(principal);
                        ...
                        return (
                            <tr>
                                ...
                                <td>{Intl.NumberFormat("en-US",options).format(open)}.00</td>
                                <td>
